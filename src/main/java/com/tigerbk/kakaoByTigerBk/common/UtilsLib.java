...
public class UtilsLib {
	 ...
	 * ConversionConfiguration이 제공하는 추가 속성은 VO에서 List 나 [] 에 사용하는 ArraySize 어노테이션에서
	 * variable=true 속성이 정의된 필드에 대해서 maxDigit과 Padding 속성을 지정할 수 있습니다.
	 * 
	 * @param obj                     byte[] 로 변환될 VO 객체.
	 * @param charSet                 byte 변환시 사용될 Encoding Character Set.
	 * @param conversionConfiguration 가변길이 List 또는 []처리시 가변 길이 정보 기록을 위한 최대
	 *                                자리수(maxDigit)와 Padding(0, ' ')을 지정합니다.
	 * @return VO 객체에서 변환 된 byte[]
	 */
	/*
...
//	private byte[] makeStream(streamVO vo) {
//
//		String result = ""; // 리턴 결과값
//		String value = "";  // 데이타 값
//		int size = 0;		//string 길이
//		String sort = "";	// R, L
//		String typeChar = ""; // null 일때 구분자..
//
//		if (vo != null) {
//			value = vo.getFiledValue();
//			sort = vo.getFiledSort();
//			typeChar = vo.getFiledSpaceChar();
//		}
//		String.format("% 3d", 5);
//		
//		if() {
...
//	}
//	
//	private static String makeChar(String val, int cnt) {
